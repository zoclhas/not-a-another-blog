...
export const USER_DETAIL_REQUEST: string = "USER_DETAIL_REQUEST";
export const USER_DETAIL_SUCCESS: string = "USER_DETAIL_SUCCESS";
export const USER_DETAIL_FAIL: string = "USER_DETAIL_FAIL";
